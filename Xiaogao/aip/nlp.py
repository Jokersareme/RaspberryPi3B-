...
class AipNlp(AipBase):
    ...
    __poemUrl = 'https://aip.baidubce.com/rpc/2.0/creation/v1/poem?charset=UTF-8'
    ...
    __text_correctionUrl = 'https://aip.baidubce.com/rpc/2.0/nlp/v2/text_correction'
    ...
    def textCorrection(self, text, options=None):
        """
            文本纠错高级版
        """
        options = options or {}
        ...
        return self._request(self.__text_correctionUrl, data)
